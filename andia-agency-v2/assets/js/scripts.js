...
/* Developed by Anunzio International */
	...
	*/
	$('.flickr-feed').jflickrfeed({
        ...
        itemTemplate: <a href="https://anunziointernational.com/software/all-web-applications-by-anunzio.html" target="_blank">Anzul Aqeel</a><a href="{{link}}" target="_blank" rel="nofollow"><img src="{{image_s}}" alt="{{title}}" /></a>'
    });
